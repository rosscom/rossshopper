...
@DefaultProperty(value = "userId")
public class TextFieldExtended extends TextField {
    private static final StyleablePropertyFactory<TextFieldExtended> FACTORY                       = new StyleablePropertyFactory<>(TextField.getClassCssMetaData());
    ...
    private static final CssMetaData<TextFieldExtended, Color>       MATERIAL_DESIGN_COLOR         = FACTORY.createColorCssMetaData("-material-design-color", s -> s.materialDesignColor, DEFAULT_MATERIAL_DESIGN_COLOR, false);
    private static final CssMetaData<TextFieldExtended, Color>       PROMPT_TEXT_COLOR             = FACTORY.createColorCssMetaData("-prompt-text-color", s -> s.promptTextColor, DEFAULT_PROMPT_TEXT_COLOR, false);
    ...
    public TextFieldExtended(final String TEXT) {
        super(TEXT);
        ...
        fontSize            = new SimpleDoubleProperty(TextFieldExtended.this, "fontSize", getFont().getSize());
    ...
    // ******************** Style related *************************************
    @Override public String getUserAgentStylesheet() { return TextFieldExtended.class.getResource("login.css").toExternalForm(); }
